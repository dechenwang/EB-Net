...
from ultralytics.nn.dsformer import BiLevelRoutingAttention,AttentionLePE,Attention
from ultralytics.nn.modules import (C1, C2, C3,CBAM, C3TR, SPP, SPPF,SimConv,CroSPPF,ASPP,Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv,CBAM, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF,CroSPPF,ASPP,SimConv, DWConv, Focus,
        ...
        elif m in {BiLevelRoutingAttention,AttentionLePE,Attention}:
            c2 = ch[f]
            args= [c2,*args]
        elif m is CBAM:
            c1, c2 = ch[f], args[0]
